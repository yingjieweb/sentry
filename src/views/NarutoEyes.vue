...
<style lang="scss" scoped>
  ...
  @keyframes colour{
    0%,30% {background-color: rgb(0, 0, 0);}
    100% {background-color: rgb(255, 4, 4);}
  }
  ...
  .cycle::after{
    ...
    border-radius: 50%;
    border: 2px solid #000;
    animation: cyclecolor 2s linear forwards;
  }
  ...
  .dian{
    ...
    border-radius: 50%;
    z-index: 10;
    animation: cycleda 3s linear forwards;
  }
  @keyframes cycleda{
    0%{
      height: 0px;
